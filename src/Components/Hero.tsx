...
const Hero = () => {
   return (
      <div className="bg-light-gray h-full flex items-center justify-center px-[10rem] py-[5rem] gap-5">
         <div>
            <h1 className="mb-2 text-6xl text-red-500 font-palanquin">Nike</h1>
            <p className="text-wrap max-w-[650px] mb-3 leading-7">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus praesentium quod deleniti doloribus perspiciatis!</p>
